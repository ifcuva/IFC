...
export const chapterImages = {
  'Alpha Epsilon Pi': '/images/aepiimage.png',
};

export const chapterContent = {
  'Alpha Epsilon Pi': {
    subtitle: 'Virginia Mu Chapter',
    image: '/images/aepiimage.png',
    details: [
      { label: 'President', value: 'William Silver', href: '#' },
      { label: 'Date founded at University of Virginia', value: 'November 29, 1924' },
      { label: 'Chapter Size as of Spring 2024', value: '66' },
      { label: 'Philanthropy', value: 'UVA Heart Family Fund' },
      { label: 'Philanthropy Chair', value: 'Jake Bernstein', href: '#' },
      { label: 'Alumni Chair', value: 'Alex Heyman', href: '#' },
      { label: 'Rush Chairs', value: 'Jonah Wilentz and Eli Beaubien', href: '#' },
    ],
    paragraphs: [
