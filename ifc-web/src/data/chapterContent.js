...
export const chapterContent = {
  ...
  'Beta Theta Pi': {
    ...
    image: null,
    details: [
      { label: 'Rush Chair', value: 'Braden Coward', href: 'mailto:bradencoward@gmail.com' },
      { label: 'Alumni Relations Chair', value: 'Gabe Garcia', href: 'mailto:cfp3te@virginia.edu' },
      { label: 'Philanthropy Chair', value: 'Shane Sugden', href: 'mailto:zve7qe@virginia.edu' },
      { label: 'Philanthropy', value: 'Bill Lowry Diversity, Equity, and Inclusivity Scholarship' },
      { label: 'Chapter Size as of Spring 2023', value: '98' },
      { label: 'Date founded at University of Virginia', value: '1855' },
      { label: 'President', value: 'Ben Harris', href: 'mailto:nra2je@virginia.edu' },
    ],
    paragraphs: [
  ...
  'Delta Sigma Phi': {
    ...
    image: null,
    details: [
      { label: 'Rush Chairs', value: 'Scotty Dunn and Jonathan Bierly' },
      { label: 'Philanthropy Chair', value: 'Aidan Broussard' },
      { label: 'Philanthropy', value: 'Jimmy V Foundation' },
      { label: 'Chapter Size as of Spring 2024', value: '78' },
      { label: 'Date founded at University of Virginia', value: '1921' },
      { label: 'President', value: 'Carter Blanks' },
    ],
    paragraphs: [
      'The Delta Sigma Phi Alpha Mu chapter at UVA has been on grounds since 1921. Delta Sig works to build better men and better lives through service, brotherhood, and academics. Our brothers are widely involved in clubs and academics at the university. They are leaders in their respective clubs and many are part of the Comm School and Batten.',
      'In recent months, we have raised thousands of dollars for City of Promise and the Shelter for Help in Emergency. Along with philanthropy, our chapter puts on many social events, including our annual Beach Formal, Parents weekend in the Fall, Fathers weekend in the Spring, and a litany of other events.',
      'Each year our chapter exemplifies positive ideals and strives to better ourselves and our community, and we hope you visit our website to learn more about our Brotherhood.',
    ],
    links: [
  ...
  'Zeta Psi': {
    ...
    image: null,
    details: [
      { label: 'Rush Chairs', value: 'Owen Cummings, Liam Wright' },
      { label: 'Philanthropy Chair', value: 'Sam Jackson' },
      { label: 'Philanthropy', value: 'One Love' },
      { label: 'Chapter Size as of Spring 202', value: '91' },
      { label: 'Date founded at University of Virginia', value: '1868' },
      { label: 'President', value: 'Edward Grinder' },
    ],
    paragraphs: [
      'Zete’s UVA chapter was founded in 1868. The Zete house is located at 169 Rugby Road. With a total roster of 71 current active members, Zete recruited another large pledge class with 26 new members during the 2023 rush season.',
      'We are very excited about the group of students we recruited, and we look forward to initiating all 23 new members to join our organization and live up to the Zete standard of commitment and dedication to the University and the community.',
    ],
    links: [
  ...
  'St. Anthony Hall': {
    ...
    image: null,
    details: [
      { label: 'Rush Chairs', value: 'Jack Finning and Rohan Agarwal' },
      { label: 'Alumni Chair', value: 'Henry Mountcastle' },
      { label: 'Philanthropy Chairs', value: 'Luke Blair and Harwell Harrison' },
      { label: 'Philanthropy', value: 'Billy Hill Memorial, Movember' },
      { label: 'Chapter Size as of Spring 2022', value: '75' },
      { label: 'Date founded at University of Virginia', value: '1860' },
      { label: 'President', value: 'Billy Kitchel' },
    ],
    paragraphs: [
  ...
  'Theta Delta Chi': {
    ...
    details: [
      ...
      { label: 'Alumni Chair', value: 'Patrick Means' },
      { label: 'Philanthropy Chairs', value: 'Elijah McFarland and Ryan Quiram' },
      { label: 'Philanthropy', value: 'The Doug Flutie & Jr. Foundation for Autism' },
      { label: 'Charge Size as of Spring 2024', value: '36' },
    ...
    paragraphs: [
      ...
      'We recently celebrated our 100th year at our house at 1811 Lambeth Lane, which is undergoing renovation in the coming months. TDX maintains strong relations with other greek organizations, the University, and the Charlottesville community through philanthropic efforts and outreach programs.',
  ...
  'Pi Kappa Phi': {
    ...
    image: null,
    details: [
      { label: 'Rush Chairs', value: 'Hunter Blosser and Aidan Drohan' },
      { label: 'Alumni Chair', value: 'Harry Shield' },
      { label: 'Philanthropy Chair', value: 'Josh Lemay' },
      { label: 'Philanthropy', value: 'The Ability Experience' },
      { label: 'Chapter Size as of Spring 2023', value: '61' },
      { label: 'Date founded at University of Virginia', value: 'May 6, 1961' },
      { label: 'President', value: 'Dylan Lam' },
    ],
    paragraphs: [
      'Heading into this Spring semester, we are excited about our new pledge class who make us excited for the future of Pi Kapp at UVA. We have a strong alumni base that has recently helped award scholarships to active brothers to fund their time at UVA.',
      'Pi Kappa Phi has become increasingly more involved in the UVA and Charlottesville community. We currently hold one of the top UVA Fraternity cumulative GPAs and have brothers in the CLAS, COMM, Batten, Architecture, and Engineering Schools.',
      'Additionally, we have brothers serving in a variety of leadership roles around Grounds across many organizations such as the IFCJC, TAMID, UVA Center for Politics, Hullabahoos, Model UN, and Club Pickleball. We have sustained consistent growth in recent years and look forward to continuing this trend.',
    ],
    links: [
  ...
  'Chi Phi': {
    ...
    details: [
      ...
      { label: 'Philanthropy Chair', value: 'Kasan Branch' },
      { label: 'Philanthropy', value: 'Octoberfest for Operation Smile' },
      { label: 'Chapter Size as of Spring 2023', value: '85' },
      { label: 'Date founded at University of Virginia', value: '1859' },
      { label: 'President', value: 'Wilson Simmons' },
    ],
    paragraphs: [
  ...
  'Sigma Alpha Mu': {
    ...
    image: null,
    details: [
      { label: 'Rush Chairs', value: 'Austin Berg and Owen Walsh' },
      { label: 'Alumni Chair', value: 'Nikhil Bharani' },
      { label: 'Philanthropy Chair', value: 'Will Lampert' },
      { label: 'Philanthropy', value: 'Sammy Spikeball for the Judy Fund at the Alzheimer’s Association' },
      { label: 'Chapter Size as of Spring 2020', value: '77' },
      { label: 'Date founded at University of Virginia', value: '1968' },
      { label: 'President', value: 'Andrew Hufford' },
    ],
    paragraphs: [
      ...
      'We are building off of our philanthropy success from last semester, as we raised over $6,000 for the Judy Fund of the Alzheimer’s Association. Once again, we will be raising money and awareness for the Alzheimer’s Association with a philanthropy event in April.',
      'Furthermore, many brothers have continually participated in Relay for Life events around grounds. Additionally, our house underwent a variety of housing improvements in the last year, specifically our new front patio which has opened up our house to outside use.',
  ...
  'Phi Society': {
    ...
    image: null,
    details: [
      { label: 'Rush Chair', value: 'Joseph Harrell' },
      { label: 'Alumni Chair', value: 'Aidan Remy' },
      { label: 'Philanthropy Chair', value: 'Andrew Broughton' },
      { label: 'Philanthropy', value: 'The Cystic Fibrosis Foundation' },
      { label: 'Chapter Size as of Spring 2023', value: '45' },
      { label: 'Date founded at University of Virginia', value: 'November 18th, 1873' },
      { label: 'President', value: 'Samuel Moran' },
    ],
    paragraphs: [
