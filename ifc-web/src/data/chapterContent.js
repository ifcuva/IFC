...
export const chapterContent = {
  ...
  'Sigma Alpha Epsilon': {
    ...
    image: null,
    details: [
      { label: 'Rush Chairs', value: 'Johnny Konidaris (ffp9hc@virginia.edu), Trent McMichael (rud3xc@virginia.edu), Myles Barnett (wjd9rt@virginia.edu), Sean Curran (hby5tn@virginia.edu)' },
      { label: 'Alumni Chair', value: 'Jack Holland', href: 'mailto:cgj4cq@virginia.edu' },
      { label: 'Philanthropy Chair', value: 'Trey Taylor', href: 'mailto:dcu4yv@virginia.edu' },
      { label: 'Philanthropy', value: 'Susan G Komen (Breast Cancer Awareness)' },
      { label: 'Chapter Size as of Spring 2026', value: '77' },
  ...
  'Phi Delta Theta': {
    ...
    image: null,
    details: [
      { label: 'Rush Chair', value: 'Ethan Spector', href: 'mailto:gbz7eu@virginia.edu' },
      { label: 'Alumni Chair', value: 'Jackson Sleadd', href: 'mailto:tdy8vs@virginia.edu' },
      { label: 'Philanthropy Chair', value: 'Aidan Stern', href: 'mailto:cpu5er@virginia.edu' },
      { label: 'Philanthropy', value: 'Habitat for Humanity, Live Like Lou' },
      { label: 'Chapter Size as of Spring 2026', value: '74' },
      { label: 'Date founded at University of Virginia', value: 'November 18, 1873' },
      { label: 'President', value: 'Lukas Lehman' },
    ],
    paragraphs: [
      'Phi Delta Theta has grown tremendously over the past year, making us excited for the future of Phi Delt at UVA. We have increased our involvement in the community and our dedication to service while continuing our successful philanthropic efforts with Delta Sigma Theta Sorority, Inc., an NPHC sorority, with our 13th annual Hoop Dreams basketball tournament. In addition, more than $5,000 has been raised for Live Like Lou, supporting ALS families, research, and awareness.',
      'We hold one of the top UVa Fraternity cumulative GPAs and represent the CLAS, COMM, Batten, Architecture, and Engineering Schools. This past year, we won Chapter of the Year, Greek Person of the Year, Outstanding Chapter President, Outstanding Philanthropy Event, and Outstanding Service to the Community at the 2025 UVA IFC Greek Awards.',
      'Additionally, we have brothers serving in various leadership roles across Grounds, including the IFC Governing Board, Cavalier Daily, Hullabahoos, Virginia Gentlemen, Class Council, and beyond. We have grown tremendously as a chapter since our rechartering in 2001 and expect even more forward progress in the coming years.',
    ],
    links: [
  ...
  'Pi Lambda Phi': {
    ...
    image: null,
    details: [
      { label: 'Rush Chair', value: 'Artun Duransvoy', href: 'mailto:xww9yd@virginia.edu' },
      { label: 'Alumni Chair', value: 'Loghan Solagar', href: 'mailto:gwq9mn@virginia.edu' },
      { label: 'Philanthropy Chair', value: 'Joseph Pastato', href: 'mailto:htu4tc@virginia.edu' },
      { label: 'Philanthropy', value: 'NAMI' },
      { label: 'Chapter Size as of Spring 2026', value: '34' },
      { label: 'Date founded at University of Virginia', value: '1932' },
      { label: 'President', value: 'Loghan Solagar', href: 'mailto:gwq9mn@virginia.edu' },
    ],
    paragraphs: [
  ...
  'Sigma Pi': {
    ...
    image: null,
    details: [
      { label: 'Rush Chairs', value: 'Tony Pham (tonypham319@gmail.com) and Denis Stepanenko (dastevmail@gmail.com)' },
      { label: 'Alumni Chair', value: 'Landen Keffer', href: 'mailto:lkeffer747@gmail.com' },
      { label: 'Philanthropy Chair', value: 'Braden Furbee', href: 'mailto:bradenfurbee@gmail.com' },
      { label: 'Philanthropy', value: 'SARA' },
      { label: 'Chapter Size as of Spring 2026', value: '38' },
      { label: 'Date founded at University of Virginia', value: 'April 4, 1959' },
      { label: 'President', value: 'James Harrison McElroy' },
    ],
    paragraphs: [
      'The brothers of Sigma Pi had a highly successful rush this Spring, bringing in a new pledge class of 16. Despite the loss of their main house at 1533 Virginia Ave. in December of 2024, they have managed to pull off one of the most incredibly comebacks on grounds. From the revitalization of their Alumni relationships spanning 65+ years, a Satellite House for the Fall and Spring of the 2025-2026 academic year, and philanthropy with SARA, a local Charlottesville nonprofit whose mission is to educate the community and assist and empower people who have experienced sexual violence. The Brothers look forward to the 2026-2027 academic year where they will see their return to 1533 Virginia Ave. A place they are ready to make their own once again.',
      'We have Brothers involved on grounds through Madison House, UVA Health, Student Council, GRC, Chi Alpha, Peer Health Educators, and more. We are all looking to make UVA and our Fraternity the best it can be.',
    ],
    links: [
      { label: 'Chapter Website', href: 'https://aig.uvaalumni.org/sigmapi/capital-campaign/' },
